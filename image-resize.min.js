...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_parchment__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_parchment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_parchment__);
...
var FloatStyle = new __WEBPACK_IMPORTED_MODULE_4_parchment__["StyleAttributor"]("float", "float");
var MarginStyle = new __WEBPACK_IMPORTED_MODULE_4_parchment__["StyleAttributor"]("margin", "margin");
var DisplayStyle = new __WEBPACK_IMPORTED_MODULE_4_parchment__["StyleAttributor"]("display", "display");
...
var ImageResize = function ImageResize(quill) {
	...
	this.showOverlay = function () {
		...
		_this.repositionElements();
		_this.quill.on("text-change", _this.repositionElements);
		_this.quill.root.addEventListener("scroll", _this.repositionElements);
	};
	...
	this.hideOverlay = function () {
		...
		// reset user-select
		_this.setUserSelect("");
		_this.quill.off("text-change", _this.repositionElements);
		_this.quill.root.parentNode.removeEventListener("scroll", _this.repositionElements);
	};
